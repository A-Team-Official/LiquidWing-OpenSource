...
public class EmptyInputBox extends Gui {
    ...
    private final GameFontRenderer cFontRenderer;
    ...
    public EmptyInputBox(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height, Color color, GameFontRenderer cFontRenderer) {
        this.id = componentId;
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            ...
            if (s.length() > 0) {
                ...
                j1 = cFontRenderer.drawString(s1, (float) l, (float) i1, i);
            }
            ...
            if (s.length() > 0 && flag && j < s.length()) {
                j1 = cFontRenderer.drawString(s.substring(j), (float) j1, (float) i1, i);
            }
