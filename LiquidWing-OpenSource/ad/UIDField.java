...
public class UIDField extends GuiTextField {
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            ...
            Fonts.font.font35.font35.drawString("User-ID", xPosition + 5, yPosition + 5, textColor);
            int i = this.isEnabled ? this.enabledColor : this.disabledColor;
            int j = this.cursorPosition - this.lineScrollOffset;
            int k = this.selectionEnd - this.lineScrollOffset;
            String s = Fonts.font.font35.font35.trimStringToWidth(this.text.substring(this.lineScrollOffset), this.getWidth());
            ...
            if (!s.isEmpty()) {
                ...
                j1 = (int) Fonts.font.font35.font35.drawString(s1, xPosition + 5, yPosition + 17, textColor, color != 0xffffffff);
            }
            ...
            if (!s.isEmpty() && flag && j < s.length()) {
                Fonts.font.font35.font35.drawString(s.substring(j), (float) j1, (float) i1, i, true);
            }
            ...
            if (flag1) {
                if (flag2) {
                    ...
                    Fonts.font.font35.font35.drawString("_", xPosition + 5 + (getText().isEmpty() ? 0 : Fonts.font.font35.font35.stringWidth(getText()) + 1), yPosition + 17, i, true);
                }
            }

            if (k != j) {
                int l1 = l + Fonts.font.font35.font35.stringWidth(s.substring(0, k));
    ...
    public void mouseClicked(int p_146192_1_, int p_146192_2_, int p_146192_3_) {
        ...
        if (this.isFocused && flag && p_146192_3_ == 0) {
            ...
            final String s = Fonts.font.font35.font35.trimStringToWidth(this.text.substring(this.lineScrollOffset), this.getWidth());
            setCursorPosition(Fonts.font.font35.font35.trimStringToWidth(s, i).length() + this.lineScrollOffset);
        }
    }
    ...
    public void setSelectionPos(int p_146199_1_) {
        ...
        final String s = Fonts.font.font35.font35.trimStringToWidth(text.substring(lineScrollOffset), j);
        final int k = s.length() + lineScrollOffset;

        if (p_146199_1_ == lineScrollOffset) {
            this.lineScrollOffset -= Fonts.font.font35.font35.trimStringToWidth(text, j, true).length();
        }
        ...
        this.lineScrollOffset = MathHelper.clamp(lineScrollOffset, 0, i);
    }
