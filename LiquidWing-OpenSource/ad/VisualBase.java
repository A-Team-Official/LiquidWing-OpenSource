...
//        GL11.glBegin(GL11.GL_QUADS);
//
//        VisualUtils.glColor(right);
//        GL11.glVertex2d(x, y + height);
//
//        VisualUtils.glColor(left);
//        GL11.glVertex2d(x + width, y + height);
//
//        VisualUtils.glColor(left);
//        GL11.glVertex2d(x + width, y);
...
//    }
//
//    public void drawLines(List<Vec3d> list) {
//        GL11.glPushMatrix();
...
//        GL11.glColor4f(1f, 1f, 1f, 1f);
//
//        for (Vec3d vector : list) {
//            GL11.glVertex3d(vector.x - mc2.getRenderManager().viewerPosX, vector.y
//                    - mc2.getRenderManager().viewerPosY, vector.z - mc2.getRenderManager().viewerPosZ);
//        }
//
...
//        GL11.glBegin(GL11.GL_QUADS);
//
//        VisualUtils.glColor(bottom);
//        GL11.glVertex2d(x, y + height);
//
//        VisualUtils.glColor(bottom);
//        GL11.glVertex2d(x + width, y + height);
//
//        VisualUtils.glColor(top);
//        GL11.glVertex2d(x + width, y);
//
//        VisualUtils.glColor(top);
//        GL11.glVertex2d(x, y);
...
//        GL11.glPushMatrix();
//        GL11.glLineWidth(2);
//        VisualUtils.glColor(new Color(color));
//        GL11.glBegin(1);
//        for (int i = 0; i <= 90; ++i) {
//            VisualUtils.glColor(new Color(color));
