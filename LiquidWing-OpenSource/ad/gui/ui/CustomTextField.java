...
//	public ModuleSlot parent;
    ...
    public void draw(float x, float y) {
        ...
        RenderUtils.drawRoundedRect(this.x, this.y + 3f, this.x + 115f, this.y + 15f, 1, new Color(200,200,200).getRGB());

        GL11.glPushMatrix();
        GL11.glEnable(GL11.GL_SCISSOR_TEST);
        RenderUtils.doGlScissor((int) this.x + 1, (int) this.y + 3, 113, 11);
        FontLoaders.F14.drawString(this.textString, this.x + 1.5f - this.offset, this.y + 6F, Color.GRAY.getRGB());

        if (this.isFocused) {
            float width = FontLoaders.F14.getStringWidth(this.textString.substring(0, selectedChar)) + 4;
            float posX = this.x + width - this.offset;
            RenderUtils.drawRect(posX - 0.5f, this.y + 5.5f, posX, this.y + 12.5f, reAlpha(Color.GRAY.getRGB(), ticks / 500 % 2 == 0 ? 1f : 0));
        }
        ...
        if (this.isFocused) {
            ...
            switch (key) {
                ...
                case Keyboard.KEY_INSERT:
                    ...
                    this.selectedChar = this.textString.length();
                    width = FontLoaders.F14.getStringWidth(this.textString.substring(0, this.selectedChar))
                            + 2;
                ...
                case Keyboard.KEY_BACK:
                    try {
                        ...
                        if (this.textString.length() != 0) {
                            ...
                            --this.selectedChar;
                            if (FontLoaders.F14.getStringWidth(oldString) + 2 > 111F && this.offset > 0.0F) {
                                newTextWidth = FontLoaders.F14.getStringWidth(this.textString) + 2;
                                oldTextWidth = FontLoaders.F14.getStringWidth(oldString) + 2;
