...
public class ArmorHud extends Element {
    ...
    public Border drawElement() {
        float armorValue = mc.getThePlayer().getTotalArmorValue();
        ...
        Fonts.sfbold32.drawCenteredString("Armor", x + 20, y + 14 - 10, -1);
        ...
        double scoef = (mc.getThePlayer().getTotalArmorValue() / 20f) * 100.0f;
