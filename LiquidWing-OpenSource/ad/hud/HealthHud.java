...
public class HealthHud extends Element {
    ...
    public Border drawElement() {
        final float health = mc.getThePlayer().getHealth();
        double hpPercentage = health / mc.getThePlayer().getMaxHealth();
        ...
        Fonts.sfbold32.drawCenteredString("HP", x + 20, y + 14 - 10, -1);
        ...
        double scoef = (mc.getThePlayer().getHealth() / mc.getThePlayer().getMaxHealth()) * 100.0f;
        ...
        Fonts.sfbold30.drawCenteredString(Math.round(scoef) + "%", x + 20, y + 22, -1);
