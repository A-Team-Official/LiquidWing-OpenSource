...
@ModuleInfo(name = "Gapple",category = ModuleCategory.HYT, description = "Gapple", Chinese = "自动吃金苹果(天坑)")
class Gapple : Module() {
    val modeValue = ListValue("Mode", arrayOf("Auto", "LegitAuto", "Once", "Head"), "Head")
    // Auto Mode
