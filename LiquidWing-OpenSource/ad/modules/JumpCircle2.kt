...
@ModuleInfo(name = "MoveCircle", description = "when jump", category = ModuleCategory.RENDER, Chinese = "跳跃特效2")
class JumpCircle2 : Module() {
    ...
    class Circle(val time: Long, val x: Double, val y: Double, val z: Double){
        val jumpModule = LiquidBounce.moduleManager.getModule(JumpCircle2::class.java) as JumpCircle2
