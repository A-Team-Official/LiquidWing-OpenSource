...
public class NewEffects extends Element {
    ...
    public Border drawElement() {
        ...
        for (final IPotionEffect potionEffect : mc.getThePlayer().getActivePotionEffects()) {
            ...
            Fonts.pop35.drawString(name + " " + intToRomanByGreedy(potionEffect.getAmplifier() + 1), 29F, posY - mc.getFontRendererObj().getFontHeight(), ClientUtils.reAlpha(HanaBiColors.WHITE.c, 0.8F));
            Fonts.pop35.drawString(potionEffect.getDurationString(), 29F, posY + 4.0F, ClientUtils.reAlpha((new Color(200, 200, 200)).getRGB(), 0.5F));
