    ...
    public void drawTextBox2() {
        if (this.getVisible()) {
            ...
            if (s.length() > 0) {
                ...
                FontLoaders.xyz18.drawString(s1.replaceAll(".", "*"), (float) l, (float) (i1 + 4), (new Color(255, 255, 255)).getRGB());
            }
            ...
            if (s.length() > 0 && flag && j < s.length()) {
                FontLoaders.xyz18.drawString(s.substring(j).replaceAll(".", "*"), (float) (j1 + 2), (float) (i1 + 4), (new Color(255, 255, 255)).getRGB());
            }
            ...
            if (flag1) {
                if (flag2) {
                    ...
                    FontLoaders.xyz20.drawString("_", (float) k1, (float) i1, i);
                }
            }
        }
