    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                drawRect(this.xPosition - 1.0F, this.yPosition - 1.0F, this.xPosition + (float) this.width + 1.0F, this.yPosition + (float) this.height + 1.0F, -6250336);
                drawRect(this.xPosition, this.yPosition, this.xPosition + (float) this.width, this.yPosition + (float) this.height, -16777216);
            }
