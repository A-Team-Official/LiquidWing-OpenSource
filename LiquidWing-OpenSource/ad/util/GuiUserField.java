    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            ...
            if (s.length() > 0) {
                ...
                j1 = this.fontRendererInstance.drawStringWithShadow(s1.replaceAll(".", "*"), l, i1, i);
            }
            ...
            if (flag1) {
                if (flag2) {
                    ...
                    this.fontRendererInstance.drawString("|", k1, i1, i);
                }
            }
    ...
    public void drawTextBox2() {
        if (this.getVisible()) {
            ...
            if (s.length() > 0) {
                ...
                Fonts.mon30.drawString(s1, (float) l + 5, (float) (i1 + 2), (new Color(255, 255, 255)).getRGB());
            }
            ...
            if (s.length() > 0 && flag && j < s.length()) {
                Fonts.mon35.drawString(s.substring(j), (float) (j1 + 2), (float) (i1 + 1), (new Color(250, 250, 250)).getRGB());
            }

            if (flag1) {
                if (flag2) {
                    Gui.drawRect(j1, i1, k1 + 1, i1 + 1 + this.fontRendererInstance.FONT_HEIGHT, -3092272);
                } else {
                    Fonts.mon30.drawString("|", (float) (k1 + 1.8) + fontRendererInstance.getStringWidth(text) * 0.90f, (float) i1 + 1, i);
                }
            }
