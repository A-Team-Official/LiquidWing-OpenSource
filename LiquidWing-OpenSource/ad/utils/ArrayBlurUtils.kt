...
object ArrayBlurUtils {
    ...
    private val shaderGroup = ShaderGroup(Minecraft.getMinecraft().textureManager, Minecraft.getMinecraft().resourceManager, Minecraft.getMinecraft().framebuffer, ResourceLocation("shaders/post/blurarea.json"))
