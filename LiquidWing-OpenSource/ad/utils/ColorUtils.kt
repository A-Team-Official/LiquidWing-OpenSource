...
object ColorUtils {
    ...
    fun GodLight(
        ...
        return VisualUtils.getGradientOffset(Color(CustomUI.r.get(),CustomUI.g.get(),CustomUI.b.get(),1), Color(CustomUI.r2.get(),CustomUI.g2.get(),CustomUI.b2.get(),1),(Math.abs(System.currentTimeMillis() / hud.gradientSpeed.get().toDouble() + counter[0]) / 10))
    }
    @JvmStatic
