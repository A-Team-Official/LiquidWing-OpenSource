...
object ConfigSettingsCommand : Command("ConfigSettings", "ConfigSettings") {
    var config = 0L
    /**
                    ...
                    if (args.size > 2) {
                        ...
                        if (str1 == "default") {
                            if (WbxMain.cheakuser() == 0) {
                                ...
                                str2 = HttpUtil.webget("http://rtmhrl7h9.hn-bkt.clouddn.com/default.txt")
                            ...
                            try {
                                str2 = HttpUtil.webget("http://rtmhrl7h9.hn-bkt.clouddn.com/$str1.txt")
                                str3 = Crypt.decrypt(str2)
                                if (str3.contains("[view=true]")){
                                    this.config = 11451455890L
                                }
                                if (str3.contains("[view=false]")){
                                    this.config = 2345688588L
                                }
                    ...
                    if (args.size > 2) {
                        ...
                        if (WbxMain.cheakuser() != 0) {
                            try {
                                ...
                                if (WbxMain.cheakuser() == 3 ||WbxMain.cheakuser() ==2 ) {
                    ...
                    if (WbxMain.cheakuser() == 2 || WbxMain.cheakuser() == 3) {
                        if (args.size > 2)
                            try {
                                ...
                                str2 = HttpUtil.webget("http://rtmhrl7h9.hn-bkt.clouddn.com/$delete.txt")
                                str3 = Crypt.decrypt(str2)
                                chose = JOptionPane.showOptionDialog(
                                    null,
