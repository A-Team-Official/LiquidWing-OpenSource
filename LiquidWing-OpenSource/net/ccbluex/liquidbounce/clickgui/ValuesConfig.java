...
public class ValuesConfig extends FileConfig {
    ...
    protected void loadConfig() throws IOException {
        if (LiquidBounce.INSTANCE.getConfigchose() == 234675 || LiquidBounce.INSTANCE.getConfigchose() == 980340) {
    ...
    protected void saveConfig() throws IOException {
        if (LiquidBounce.INSTANCE.getConfigchose() == 234675 || LiquidBounce.INSTANCE.getConfigchose() == 980340 || (ConfigSettingsCommand.INSTANCE.getConfig() == 11451455890L && LiquidBounce.INSTANCE.getConfigchose() == 114514)) {
            ...
            LiquidBounce.moduleManager.getModules().forEach(module -> {
                ...
                jsonModule.addProperty("State", module.getState());
                jsonModule.addProperty("KeyBind", module.getKeyBind());
                jsonModule.addProperty("Array", module.getArray());
