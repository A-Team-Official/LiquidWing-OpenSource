...
@ModuleInfo(name = "ColorMixer", description = "Mix two colors together.", category = ModuleCategory.COLOR, canEnable = false, Chinese = "混色器")
public class ColorMixer extends Module {
    ...
    public final IntegerValue blendAmount = new IntegerValue("Mixer-Amount", 2, 2, 10) {
        ...
        protected void onChanged(final Integer oldValue, final Integer newValue) {
            regenerateColors(!oldValue.equals(newValue));
        }
    };
    /*
    @Override
