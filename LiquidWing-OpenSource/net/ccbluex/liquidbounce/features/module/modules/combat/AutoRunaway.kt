...
@ModuleInfo(
    ...
    category = ModuleCategory.COMBAT, Chinese = "自动跑路"
)
    ...
    fun onUpdate(event: UpdateEvent) {
        if (mc.thePlayer != null && mc.thePlayer!!.health < health.get()) {
            ...
            if (mc.thePlayer!!.health <= health.get() && autoDisable.get()) {
                ModuleUtils.disableModules(KillAura::class.java, Speed::class.java, Scaffold::class.java, InventoryCleaner::class.java, ChestStealer::class.java)
            }
