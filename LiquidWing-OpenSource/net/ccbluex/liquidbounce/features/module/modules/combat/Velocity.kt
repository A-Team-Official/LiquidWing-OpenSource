...
@ModuleInfo(name = "Velocity", description = "修复版", category = ModuleCategory.COMBAT, Chinese = "击退覆盖")
    ...
    fun onUpdate(event: UpdateEvent) {
        ...
        when (modeValue.get().toLowerCase()) {
            ...
            "liquidwing"->{
                ...
                if (killAura.target != null && mc.thePlayer!!.hurtTime > 0 && killAura.jump.get() && mc.thePlayer!!.onGround) {
                    mc.thePlayer!!.jump()
                }
