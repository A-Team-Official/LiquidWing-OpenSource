...
@ModuleInfo(name = "FakeFPS", description = "", category = ModuleCategory.MISC, array = false, Chinese = "虚假帧数")
class FakeFPS : Module() {
    private val maxFps:IntegerValue = object : IntegerValue("MaxFPS",1000,30,100000) {
