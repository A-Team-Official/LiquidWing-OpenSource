package net.ccbluex.liquidbounce.features.module.modules.misc;//package net.ccbluex.liquidbounce.features.module.modules.misc;
//
...
//
//        Display.setTitle(defaultText + (time.get() ? " " + timeText : ""));
//    }
//
//    @Override
//    public void onDisable() {
//        try {
//            Display.setTitle("LiquidWing " + CLIENT_VERSION + "r | " + HttpUtils.get("https://v1.hitokoto.cn/?c=f&encode=text"));
//        } catch (Exception e) {
//            Display.setTitle("LiquidWing " + CLIENT_VERSION + "r");
//        }
//    }
//}
