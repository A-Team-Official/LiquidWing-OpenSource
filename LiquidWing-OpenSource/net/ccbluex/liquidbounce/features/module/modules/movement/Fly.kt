...
@ModuleInfo(name = "Fly", description = "Allows you to fly in survival mode.", category = ModuleCategory.MOVEMENT, keyBind = Keyboard.KEY_F, Chinese = "飞行")
class Fly : Module() {
...
//                    mc.effectRenderer.spawnEffectParticle(EnumParticleTypes.FLAME.getParticleID(), thePlayer.posX, thePlayer.posY + 0.2, thePlayer.posZ, -thePlayer.motionX, -0.5, -thePlayer.motionZ)
                ...
                "watchcat" -> {
                    ...
                    if (thePlayer.posY < startY + 2) {
                        thePlayer.motionY = Math.random() * 0.48954512
                        return@run
                    }
