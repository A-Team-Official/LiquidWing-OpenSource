...
@ModuleInfo(name = "Sprint", description = "Automatically sprints all the time.", category = ModuleCategory.MOVEMENT, Chinese = "保持疾跑")
public class Sprint extends Module {
    ...
    public  final BoolValue jumpDirectionsValue = new BoolValue("JumpDirections", false);
