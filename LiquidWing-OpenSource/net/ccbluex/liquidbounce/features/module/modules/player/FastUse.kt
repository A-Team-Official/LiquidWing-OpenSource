...
@ModuleInfo(name = "FastUse", description = "Allows you to use items faster.", category = ModuleCategory.PLAYER, Chinese = "快速使用")
class FastUse : Module() {

    private val modeValue = ListValue("Mode", arrayOf("Instant", "Test","Hytnew", "NCP", "AAC", "CustomDelay"), "Test")
    private val timer = FloatValue("Test-timer", 0.5f, 0.0f, 1f)
