...
@ModuleInfo(name = "DamageParticle", description = "Display heatlh volume change value", category = ModuleCategory.RENDER, Chinese = "伤害数值显示")
public class DMGParticle extends Module {
    ...
    public void onRender(Render3DEvent event) {
        for (Particles p : this.particles) {
            ...
            net.ccbluex.liquidbounce.ui.font.Fonts.rise40.drawString(p.text, (float)(-( net.ccbluex.liquidbounce.ui.font.Fonts.rise40.getStringWidth(p.text) / 2)), (float)(-( net.ccbluex.liquidbounce.ui.font.Fonts.rise40.getFontHeight() - 1)), 0);
