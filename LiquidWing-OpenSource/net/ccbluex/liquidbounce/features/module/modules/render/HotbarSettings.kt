...
@ModuleInfo(name = "Hotbar", category = ModuleCategory.RENDER, description = "233", Chinese = "物品栏设置")
class HotbarSettings : Module() {
    ...
    fun onRender2D(event: Render2DEvent) {
        ...
        when {
            hotbarValue.get().equals("Rise",true) -> {
            ...
            hotbarValue.get().equals("Full",true) -> {
            ...
            hotbarValue.get().equals("LB",true) -> {
            ...
            hotbarValue.get().equals("Overflow",true) -> {
            ...
            hotbarValue.get().equals("Gradient",true) -> {
            ...
            hotbarValue.get().equals("Glow",true) -> {
            ...
            hotbarValue.get().equals("BlueIce",true) -> {
            ...
            hotbarValue.get().equals("Exhi",true) -> {
            ...
            hotbarValue.get().equals("Bread",true)  -> {
            ...
            hotbarValue.get().equals("Rounded",true) -> {
            ...
            hotbarValue.get().equals("Dock",true) -> {
            ...
            hotbarValue.get().equals("Glowing",true)  -> {
    ...
    fun HotbarItems(index: Int, xPos: Int, yPos: Int) {
        ...
        if (itemstack != null) {
            ...
            when {
                ItemFontValue.get().equals("MiSans",true) -> {
                    fontVal = Fonts.pop35
                }
                ItemFontValue.get().equals("Minecraft",true) -> {
        ...
        if (stack != null) {
            if (stack.stackSize != 1 || text != null) {
                ...
                if(ItemCountValue.get()){
                    ...
                    if (text == null && stack.stackSize < 1) { s = WEnumChatFormatting.RED.toString() + stack.stackSize.toString() }
                    colour = Color.white
                }
                var fontVal = mc.fontRendererObj
                when {
                ...
                GlStateManager.disableBlend()
                fontVal.drawStringWithShadow(s,
    ...
    private fun barDraw(renderer: BufferBuilder, x: Int, y: Int, width: Int, height: Int, red: Int, green: Int, blue: Int, alpha: Int) {
    ...
    private var easingValue = 0
        ...
        set(value) {
            ...
            if(hotbarValue.get().equals("Dock",true)){ hotbarSpeed = 4}
