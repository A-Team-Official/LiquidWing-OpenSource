...
@ModuleInfo(name = "Tower", description = "Automatically builds a tower beneath you.", category = ModuleCategory.WORLD, keyBind = Keyboard.KEY_O, Chinese = "向上搭")
class Tower : Module() {
    /**
     * OPTIONS
     */
    ...
    fun onRender2D(event: Render2DEvent) {
        if (counterDisplayValue.get()) {
            ...
            RenderUtils.drawBorderedRect(scaledResolution.scaledWidth / 2 - 2.toFloat(),
                    ...
                    scaledResolution.scaledWidth / 2 + Fonts.pop40.getStringWidth(info) + 2.toFloat(),
                    scaledResolution.scaledHeight / 2 + 16.toFloat(), 3f, Color.BLACK.rgb, Color.BLACK.rgb)

            classProvider.getGlStateManager().resetColor()

            Fonts.pop40.drawString(info, scaledResolution.scaledWidth / 2.toFloat(),
