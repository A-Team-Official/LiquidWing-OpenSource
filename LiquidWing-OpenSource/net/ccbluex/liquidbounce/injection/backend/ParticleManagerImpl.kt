...
class ParticleManagerImpl(val wrapped: ParticleManager) : IParticleManager {
    override fun emitParticleAtEntity(entity: IEntity, buffer: EnumParticleTypes) = wrapped.emitParticleAtEntity(entity.unwrap(),buffer)
    override fun spawnEffectParticle(particleID:Int, posX:Double, posY:Double, posZ:Double, motionX:Double, motionY:Double, motionZ:Double, StateId:Int) {
