...
import ad.ParticleEngine
import ad.sb.novoline.ui.GuiMainMenu
import net.ccbluex.liquidbounce.LiquidBounce
import net.ccbluex.liquidbounce.api.util.WrappedGuiScreen
import net.ccbluex.liquidbounce.ui.client.clickgui.skeet.TimerUtil
...
class GuiWelcome : WrappedGuiScreen() {
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        val fontwel2 = FontLoaders.F20
        val fontwel: FontDrawer = FontLoaders.F35
        ...
        fontwel.drawCenteredStringWithShadow(
            ...
            translate.getX().toDouble(),
            translate.getY().toDouble(),
