...
import net.ccbluex.liquidbounce.ui.client.clickgui.skeet.settings.*;
...
public class ModuleRender {
    ...
    public void draw(int mx, int my) {
        ...
        RenderUtils.drawRoundedRect((float)(this.mainx + 10) + this.x, (float)(this.mainy + 35) + this.y,(float)(this.mainx + 10) + this.x+ 160.0F,(float)(this.mainy + 35) + this.y+ this.pos.height, 2, new Color(1,11,21, 255).getRGB());
     ...
     //   FontLoaders.NL18.drawString("Enable", var10002, var10003, new Color(130,140,150).getRGB());
        RenderUtils.drawRect((float)(this.mainx + 153) + this.x, (float)(this.mainy + 40) + this.y, (float)(this.mainx + 153) + this.x+8.0F,  (float)(this.mainy + 40) + this.y+8.0F, new Color(5,23,37).getRGB());
        if (this.module.getState()) {
        	  RenderUtils.drawCheck((double)((float)this.mainx + 154.5F + this.x), (double)((float)this.mainy + 43.5F + this.y), 2,   (new Color(5,166,238)).getRGB());
        }
    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) {
        if (mouseButton == 0 && RenderUtils.isHovering((float)(this.mainx + 153) + this.x, (float)(this.mainy + 40) + this.y, 8.0F, 8.0F, mouseX, mouseY)) {
