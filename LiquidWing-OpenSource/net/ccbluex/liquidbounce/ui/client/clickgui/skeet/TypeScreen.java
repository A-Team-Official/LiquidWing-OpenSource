...
public class TypeScreen {
    ...
    public void draw(int mx, int my) {
       ...
       if (this.selected) {
           RenderUtils.drawRoundedRect((float)(this.mainx -95 ), (float)this.mainy+50+ this.x,(float)(this.mainx -65) + 60,this.mainy+ 68F+ this.x,2, (new Color(4,51,77)).getRGB());
       }
     //  RenderUtils.drawImage(new ResourceLocation("Boker/clickgui/RENDER.png"), (int)mainx + 5, (int)mainx + 60, 0, 0);
  ...
  //      FontLoaders.NL24.drawString(this.newcatename(this.type), (float)(this.mainx -70 ), (float)(this.mainy + 55)+ this.x,  (new Color(255, 255, 255)).getRGB());
      ...
      //  Client.INSTANCE.getFontManager().check18.drawString(l2, var10002, (float)(this.mainy + 16), this.selected ? Hud.colorValue.getValue() : (new Color(133, 135, 139)).getRGB());
        ...
        if (this.selected) {
            GL11.glPushMatrix();
            RenderUtils.doGlScissor((double)this.mainx, (double)(this.mainy + 35), 500.0, 305.0);
            GL11.glEnable(3089);
            ...
            ModuleRender module;
            for(Iterator var7 = this.moduleRect.iterator(); var7.hasNext(); module.scrollY = (int) MathUtils.roundToHalf(scrolll)) {
    ...
    public void onScroll(int ms, int mx, int my) {
        ...
        if (RenderUtils.isHovering((float)this.mainx, (float)(this.mainy + 35), 350.0F, 265.0F, mx, my)) {
    ...
    public boolean isHovered(int mouseX, int mouseY) {
        return RenderUtils.isHovering((float)(this.mainx -70 ), (float)(this.mainy + 54)+ this.x, (float) FontLoaders.NL18.getStringWidth(this.newcatename(this.type))+10, (float)(FontLoaders.NL18.getHeight() + 42)+ this.x, mouseX, mouseY);
    }
}
