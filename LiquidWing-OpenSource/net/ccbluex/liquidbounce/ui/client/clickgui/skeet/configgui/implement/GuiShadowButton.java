package net.ccbluex.liquidbounce.ui.client.clickgui.skeet.configgui.implement;
...
public class GuiShadowButton extends Gui {
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY) {
        if (this.visible) {
            ...
            RenderUtils.drawRect(this.xPosition, this.yPosition, xPosition + width, yPosition + height, new Color(0, 0, 0, 140).getRGB());
