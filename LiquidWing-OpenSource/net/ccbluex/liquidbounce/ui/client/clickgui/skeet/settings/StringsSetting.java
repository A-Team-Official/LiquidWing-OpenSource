...
public class StringsSetting extends Downward<ListValue> {
    ...
    public void draw(int mouseX, int mouseY) {
        ...
        RenderUtils.drawRect((float)(this.mainx + 91) + this.pos.x, (float)(this.mainy + 35 + this.y),(float)(this.mainx + 91) + this.pos.x+ 70.0F, (float)(this.mainy + 35 + this.y)+ 12.0F,  new Color(5,23,37).getRGB());
        ...
        if (((ListValue)this.setting).openList) {
            ...
            RenderUtils.drawRect((float)(this.mainx + 91) + this.pos.x, (float)(this.mainy + 35 + 12 + this.y),(float)(this.mainx + 91) + this.pos.x+ 70.0F,(float)(this.mainy + 35 + 12 + this.y)+ (float)((ListValue)this.setting).getModes().size() * 12.0F, new Color(5,23,37).getRGB());
            List<String> var5 = ((ListValue)this.setting).getModes();
            int var6 = var5.size();

            for (String option : var5) {
                if (option.equals(this.setting.get())) {
                    RenderUtils.drawRect((float) (this.mainx + 91 + 69) + this.pos.x, (float) (this.mainy + 38 + 11 + this.y + ((ListValue) this.setting).getModeListNumber(String.valueOf(option)) * 12), (float) (this.mainx + 91 + 69) + this.pos.x + 1.0F, (float) (this.mainy + 38 + 11 + this.y + ((ListValue) this.setting).getModeListNumber(String.valueOf(option)) * 12) + 8.0F, new Color(5, 166, 238).getRGB());
                }
    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) {
        if (mouseButton == 1 && RenderUtils.isHovering((float)(this.mainx + 91) + this.pos.x, (float)(this.mainy + 35 + this.y), 70.0F, 12.0F, mouseX, mouseY)) {
