...
class Arraylist(x: Double = 1.0, y: Double = 2.0, scale: Float = 1F,
    ...
    private val fontValue = FontValue("Font", Fonts.pop40)
    ...
    var fontRenderer = Fonts.productSans40
            ...
            Horizontal.RIGHT, Horizontal.MIDDLE -> {
                        ...
                        modules.forEachIndexed { index, module ->
                            ...
                            RenderUtils.newDrawRect(
                                ...
                                when (shadowColorMode.get().toLowerCase()) {
                                    ...
                                    {VisualUtils.getGradientOffset3(Color(CustomUI.r.get(), CustomUI.g.get(), CustomUI.b.get(),backgroundColorAlphaValue.get()), Color(CustomUI.r2.get(), CustomUI.g2.get(), CustomUI.b2.get(),backgroundColorAlphaValue.get()), (Math.abs(
                ...
                modules.forEachIndexed { index, module ->
                    ...
                    RenderUtils.drawRect(
                        ...
                        {VisualUtils.getGradientOffset(Color(CustomUI.r.get(), CustomUI.g.get(), CustomUI.b.get(),backgroundColorAlphaValue.get()), Color(CustomUI.r2.get(), CustomUI.g2.get(), CustomUI.b2.get(),backgroundColorAlphaValue.get()),index * 1f.toDouble()).rgb}
