...
import ad.utils.ArrayBlurUtils
import ad.utils.Color.VisualUtils
 ...
 */
@ElementInfo(name = "Arraylist-CN", single = true)
class ChineseArraylist(x: Double = 1.0, y: Double = 2.0, scale: Float = 1F,
    ...
    private val rectRightValue = ListValue("Rect-Right", arrayOf("None", "Left","NormalLeft" ,"Right", "Top", "Rise"), "Right")
            ...
            Horizontal.RIGHT, Horizontal.MIDDLE -> {
                    ...
                    ShadowUtils.shadow(shadowStrength.get().toFloat(), {
                        ...
                        modules.forEachIndexed { index, module ->
                            ...
                            RenderUtils.newDrawRect(
                                xPos - if (rectRightValue.get().equals("right", true)) 5 else if (rectRightValue.get().equals("rise", true)) 5 else 4,
                                module.higt,
                                if (rectRightValue.get().equals("right", true)) -4F else if (rectRightValue.get().equals("rise", true)) -4F else -3F,
                                ...
                                when (shadowColorMode.get().toLowerCase()) {
                                    ...
                                    "text" -> {
                                        ...
                                        when {
                                            ...
                                            colorMode.equals("Gradinet", true) -> VisualUtils.getGradientOffset(Color(CustomUI.r.get(), CustomUI.g.get(), CustomUI.b.get()), Color(CustomUI.r2.get(), CustomUI.g2.get(), CustomUI.b2.get()), index * 1f.toDouble()).rgb
                                            else -> customColor
                                        }
                                    }
                ...
                if (blurValue.get()) {
                    ...
                    modules.forEachIndexed { index, module ->
                        ...
                        val wid = fontRenderer.getStringWidth(dString).toFloat()
                    ...
                    ArrayBlurUtils.blur(floatX, floatY, floatX + xP, floatY + yP, blurStrength.get(), false) {
                        modules.forEachIndexed { index, module ->
                            val xPos = -module.slide - 2
                            RenderUtils.quickDrawRect(
                                floatX + xPos - if (rectRightValue.get().equals("right", true)) 5 else if (rectRightValue.get().equals("rise", true)) 5 else 4,
                                floatY + module.higt,
                                floatX + if (rectRightValue.get().equals("right", true)) -4F else if (rectRightValue.get().equals("rise", true)) -4F else -3F,
                ...
                modules.forEachIndexed { index, module ->
                    ...
                    fontRenderer.drawString(displayString,
                        ...
                        ((module.higt + textY)), when {
                            ...
                            colorMode.equals("LiquidSlowly", ignoreCase = true) -> LiquidSlowly
                            colorMode.equals("Fade", ignoreCase = true) -> FadeColor
                            colorMode.equals("Gradinet", true) ->VisualUtils.getGradientOffset(Color(CustomUI.r.get(), CustomUI.g.get(), CustomUI.b.get()), Color(CustomUI.r2.get(), CustomUI.g2.get(), CustomUI.b2.get(),1), (Math.abs(
                    ...
                    if (!rectRightValue.get().equals("none", true)) {
                        ...
                        val rectColor = when {
                            ...
                            rectColorMode.equals("Gradinet", true) -> VisualUtils.getGradientOffset(Color(CustomUI.r.get(), CustomUI.g.get(), CustomUI.b.get()), Color(CustomUI.r2.get(), CustomUI.g2.get(), CustomUI.b2.get(),1), (Math.abs(
                                System.currentTimeMillis() / gidentspeed.get()
                                    .toDouble() + (module.higt / fontRenderer.height)
                            ) / 10)).rgb
                        ...
                        if (rectcolor.get().equals("Text")){
                            when {
                                rectRightValue.get().equals("normalleft", true) -> RenderUtils.drawRect(xPos - 4, module.higt, xPos - 3f, module.higt + textHeight, rectColor)
                                rectRightValue.get().equals("right", true) -> RenderUtils.drawRect(-5F, module.higt, -4f,
                                ...
                                rectRightValue.get().equals("rise", true) -> {
                                    RenderUtils.drawRect(-5.2F, module.higt + 1F, -4F, module.higt + textHeight - 1F, rectColor)
                                }
                            }
                        }
                        if (rectcolor.get().equals("Custom")){
                            when {
                                rectRightValue.get().equals("left", true) -> RoundedUtil.drawRound(xPos - 4, module.higt, xPos - 3f, textHeight,leftrad.get(), customrect)
                                rectRightValue.get().equals("normalleft", true) -> RenderUtils.drawRect(xPos - 4, module.higt, xPos - 3f, module.higt + textHeight, customrect)
                                rectRightValue.get().equals("right", true) -> RenderUtils.drawRect(-5F, module.higt, -4f,
                                ...
                                rectRightValue.get().equals("rise", true) -> {
                                    RenderUtils.drawRect(-5.2F, module.higt + 1F, -4F, module.higt + textHeight - 1F, customrect)
                                }
                            }
                        }
                    }
    ...
    override fun updateElement() {
        modules = if (abcOrder.get()) LiquidBounce.moduleManager.modules
            ...
            .filter { it.array && (if (hAnimation.get().equals("none", ignoreCase = true)) it.state else it.slide > 0) }
            .sortedBy { -fontValue.getStringWidth(getModName(it)) }
        sortedModules = if (abcOrder.get()) LiquidBounce.moduleManager.modules.toList()
        else LiquidBounce.moduleManager.modules.sortedBy { -fontValue.getStringWidth(getModName(it)) }.toList()
    }
    ...
    fun getModName(mod: Module): String {
        var displayName : String = mod.Chinese + getModTag(mod)
