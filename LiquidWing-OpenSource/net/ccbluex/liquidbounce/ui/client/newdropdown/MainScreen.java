...
import static net.ccbluex.liquidbounce.ui.client.newdropdown.utils.render.DrRenderUtils.isHovering;
...
public class MainScreen implements Screen {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        Fonts.tenacitybold.tenacitybold26.tenacitybold26.drawString(category.name(), x + 5, y + Fonts.tenacitybold.tenacitybold26.tenacitybold26.getMiddleOfBox(categoryRectHeight), textColor);
       ...
       // String icon = category.icon;
        ...
        else if (category.name().equalsIgnoreCase("Color")) {
            l = "M";
        }
        else if (category.name().equalsIgnoreCase("Hyt")) {
            l = "D";
        }
