      ...
      //  }
       ...
       // }
        ...
        if (!clickAnimation.isDone()) {
            drag.setX(Utils333.interpolateFloat(sr.getScaledWidth() - 30, focused ? sr.getScaledWidth() / 2f - rectWidth / 2f : drag.getX(), (float) clickAnimation.getOutput()));
            drag.setY(Utils333.interpolateFloat(sr.getScaledHeight() / 2f - rectHeight / 2f, drag.getY(), (float) clickAnimation.getOutput()));
        }
        ...
        for (String category : categories) {
            ...
            boolean hovered = DrRenderUtils.isHovering(xVal - 30, yVal - 5, 60, Fonts.tenacitybold.tenacitybold26.tenacitybold26.getHeight() + 10, mouseX, mouseY);
            ...
            final ClickGUI hud = (ClickGUI) LiquidBounce.moduleManager.getModule(ClickGUI.class);
            ...
            RoundedUtil.drawRound(xVal - 30, yVal - 5, 60, Fonts.tenacitybold.tenacitybold26.tenacitybold26.getHeight() + 10, 6, finalColor);

            DrRenderUtils.resetColor();
            Fonts.tenacitybold.tenacitybold26.tenacitybold26.drawCenteredString(category, xVal, y + 15, textColor);
            seperation += 100;
        }
