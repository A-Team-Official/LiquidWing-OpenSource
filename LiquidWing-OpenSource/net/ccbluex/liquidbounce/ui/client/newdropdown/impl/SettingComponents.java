    ...
    public void handle(int mouseX, int mouseY, int button, GuiEvents type) {
        ...
        for (Value setting : module.getValues()) {
            ...
            if (setting instanceof FloatValue) {
                ...
                float regularFontWidth = (float) Fonts.tenacity.tenacity18.tenacity18.stringWidth(numberSetting.getName() + ": ");
                float valueFontWidth = (float) Fonts.tenacity.tenacity18.tenacity18.stringWidth(value);

                float titleX = x + width / 2f - (regularFontWidth + valueFontWidth) / 2f;
                float titleY = settingY + Fonts.tenacity.tenacity18.tenacity18.getMiddleOfBox(rectHeight) -
                        Fonts.tenacity.tenacity18.tenacity18.getMiddleOfBox(rectHeight) / 2f + 1;
                GlStateManager.color(1, 1, 1, 1);

                Fonts.tenacity.tenacity18.tenacity18.drawString(numberSetting.getName() + ": ", titleX, titleY, textColor.getRGB());
                GlStateManager.color(1, 1, 1, 1);

                Fonts.tenacitybold.tenacitybold18.tenacitybold18.drawString(value, titleX + regularFontWidth, titleY, textColor.getRGB());
                ...
                RoundedUtil.drawRound(x + 5, sliderY, totalSliderWidth, 3, 1.5f, Utils333.applyOpacity(darkRectHover, (float) (.4f + (.2 * hoverAnimation.getOutput()))));
                RoundedUtil.drawRound(x + 5, sliderY, Math.max(4, sliderfloatMap.get(numberSetting)), 3, 1.5f, accent ? accentedColor2 : textColor);

                Utils333.setAlphaLimit(0.0F);
                Utils333.fakeCircleGlow(x + 4 + Math.max(4, sliderfloatMap.get(numberSetting)), sliderY + 1.5f, 6,
                        Color.BLACK, .3f);

                Utils333.drawGoodCircle(x + 4 + Math.max(4, sliderfloatMap.get(numberSetting)), sliderY + 1.5f, 3.75f, accent ? accentedColor2.getRGB() : textColor.getRGB());
                count += .5f;
            }
            if (setting instanceof IntegerValue) {
                ...
                Utils333.setAlphaLimit(0);
                Utils333.fakeCircleGlow(x + 4 + Math.max(4, sliderintMap.get(numberSetting)), sliderY + 1.5f, 6,
                        Color.BLACK, .3f);

                Utils333.drawGoodCircle(x + 4 + Math.max(4, sliderintMap.get(numberSetting)), sliderY + 1.5f, 3.75f, accent ? accentedColor2.getRGB() : textColor.getRGB());
                count += .5f;
            }
            if (setting instanceof BoolValue) {
                ...
                Fonts.tenacity.tenacity18.tenacity18.drawString(booleanSetting.getName(), (int) MathUtils.roundToHalf(x + 4), settingY +
                        5, textColor.getRGB());

                float switchWidth = 16;

                boolean hoveringSwitch = isClickable(settingY + Fonts.tenacity.tenacity18.tenacity18.getMiddleOfBox(rectHeight) - 1) &&
                        DrRenderUtils.isHovering(x + width - (switchWidth + 6), settingY + Fonts.tenacity.tenacity18.tenacity18.getMiddleOfBox(rectHeight) - 1,
                ...
                RoundedUtil.drawRound(x + width - (switchWidth + 5.5f), settingY + Fonts.tenacity.tenacity18.tenacity18.getMiddleOfBox(rectHeight) + 2, switchWidth, 4.5f,
                ...
                DrRenderUtils.fakeCircleGlow((float) ((x + width - (switchWidth + 3)) + ((switchWidth - 5) * toggleAnimation.getOutput())),
                        settingY + Fonts.tenacity.tenacity18.tenacity18.getMiddleOfBox(rectHeight) + 4, 6, Color.BLACK, .3f);

                DrRenderUtils.resetColor();

                RoundedUtil.drawRound((float) (x + width - (switchWidth + 6) + ((switchWidth - 5) * toggleAnimation.getOutput())),
                        settingY + Fonts.tenacity.tenacity18.tenacity18.getMiddleOfBox(rectHeight) + 1, 6.5f,
                        6.5f, 3, textColor);
            ...
            if (setting instanceof ListValue) {
                ...
                for (String mode : modeSetting.getValues()) {
                    ...
                    if (openAnimation.isDone() && openAnimation.getDirection().equals(Direction.FORWARDS) || !openAnimation.isDone()) {
                        ...
                        Fonts.tenacity.tenacity18.tenacity18.drawString(mode, x + 13, modeY,DrRenderUtils.applyOpacity(textColor, (float) openAnimation.getOutput()).getRGB());
                    }
                    //   Fonts.tenacity.tenacity18.tenacity18.drawString(mode, x + 13, modeY,DrRenderUtils.applyOpacity(textColor, (float) openAnimation.getOutput()).getRGB());
                    modeCount++;
                }
                ...
                //Mode的名字
                Fonts.tenacity.tenacity14.tenacity14.drawString(modeSetting.getName(), x + 13, settingY + 9, textColor.getRGB());

                DrRenderUtils.resetColor();
                //当先选择的mode
                Fonts.tenacitybold.tenacitybold18.tenacitybold18.drawString(modeSetting.get(), x + 13, (float) (settingY + 17.5), textColor.getRGB());
            ...
            if (setting instanceof TextValue) {
                ...
                DrRenderUtils.resetColor();
                Fonts.tenacity.tenacity16.tenacity16.drawString(stringSetting.getName(), x + 5, settingY + 2, textColor.getRGB());

                PasswordField stringSettingField = new PasswordField("Type Here...", 0,
                        (int) (x + 5), (int) (settingY + 15), (int) (width - 10), 10, (FontRenderer) Fonts.tenacity.tenacity18.tenacity18);
            ...
            /*
                ...
                boolean hoveringBindRect = isClickable(settingY + Fonts.tenacitybold.tenacitybold18.tenacitybold18.getMiddleOfBox(rectHeight) - 1)
                        && DrRenderUtils.isHovering((float) (x + width - (Fonts.tenacitybold.tenacitybold18.tenacitybold18.stringWidth(bind) + 7)),
                        settingY + Fonts.tenacitybold.tenacitybold18.tenacitybold18.getMiddleOfBox(rectHeight) - 1, (float) (Fonts.tenacitybold.tenacitybold18.tenacitybold18.stringWidth(bind) + 4),
                        Fonts.tenacitybold.tenacitybold18.tenacitybold18.getHeight() + 4, mouseX, mouseY);
                ...
                Fonts.tenacity.tenacity18.tenacity18.drawString("Bind", x + 5,
                        settingY + Fonts.tenacity.tenacity18.tenacity18.getMiddleOfBox(rectHeight) + 1,
                        textColor.getRGB());
                ...
                RoundedUtil.drawRound((float) (x + width - (Fonts.tenacitybold.tenacitybold18.tenacitybold18.stringWidth(bind) + 9)),
                        settingY + Fonts.tenacitybold.tenacitybold18.tenacitybold18.getMiddleOfBox(rectHeight) - 1, (float) (Fonts.tenacitybold.tenacitybold18.tenacitybold18.stringWidth(bind) + 5),
                        Fonts.tenacitybold.tenacitybold18.tenacitybold18.getHeight() + 3.5f, 5, DrRenderUtils.applyOpacity(darkRectHover, (float) (.4 + (.2 * animations[0].getOutput()))));

                Fonts.tenacitybold.tenacitybold18.tenacitybold18.drawString(bind, x + width - (Fonts.tenacitybold.tenacitybold18.tenacitybold18.stringWidth(bind) + 6),
                        settingY + Fonts.tenacitybold.tenacitybold18.tenacitybold18.getMiddleOfBox(rectHeight) + 1,
