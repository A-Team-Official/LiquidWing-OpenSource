...
public class GradientUtil implements Utils {
    ...
    private static final ShaderUtil gradientMaskShader = new ShaderUtil("liquidwing/Shaderss/gradientmask.frag");
    private static final ShaderUtil gradientShader = new ShaderUtil("liquidwing/Shaderss/gradient.frag");
    ...
    public static void applyGradientCornerRL(float x, float y, float width, float height, float alpha, Color bottomLeft, Color topRight, Runnable content) {
        Color mixedColor = DrRenderUtils.interpolateColorC(topRight, bottomLeft, .5f);
