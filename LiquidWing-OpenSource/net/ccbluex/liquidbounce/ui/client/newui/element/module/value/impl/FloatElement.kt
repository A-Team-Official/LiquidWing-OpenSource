...
class FloatElement(val savedValue: FloatValue): ValueElement<Float>(savedValue) {
    ...
    override fun drawElement(mouseX: Int, mouseY: Int, x: Float, y: Float, width: Float, bgColor: Color, accentColor: Color): Float {
        val valueDisplay = 30F + Fonts.misans40.getStringWidth("${savedValue.maximum.toInt().toFloat() + 0.01F}")
        ...
        val currLength = Fonts.misans40.getStringWidth("${round(savedValue.get())}")
        ...
        FontLoaders.F20.drawStringWithShadow("${round(savedValue.get())}", x + width + 6F - valueDisplay, y + 10F - FontLoaders.F20.height / 2F + 2F, -1)
        ...
        FontLoaders.F20.drawStringWithShadow("+", x + width - 17F, y + 10F - FontLoaders.F20.height / 2F + 2F, -1)
            ...
            RenderUtils.customRounded(x + width - 18F, y + 2F, x + width - 10F, y + 18F, 0F, 4F, 4F, 0F, ColorManager.buttonOutline.rgb)
            RenderUtils.customRounded(x + width - 5F - valueDisplay, y + 2F, x + width + 3F - valueDisplay, y + 18, 4F, 0F, 0F, 4F, ColorManager.buttonOutline.rgb)
            Fonts.misans40.drawString("${round(savedValue.get())}", x + width + 6F - valueDisplay, y + 10F - Fonts.misans40.fontHeight / 2F + 2F, -1)
