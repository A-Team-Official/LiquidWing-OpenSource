    ...
    override fun drawString(text: String?, x: Float, y: Float, color: Int, shadow: Boolean): Int {
        ...
        if (shadow) {
            if (HUD.shadowValue.get().equals("LiquidBounce")) {
                ...
                drawText(currentText, x + 0.5f, currY - 0.5f, Color(0, 0, 0, 130).rgb, true)
                drawText(currentText, x - 0.5f, currY + 0.5f, Color(0, 0, 0, 130).rgb, true)
            } else if (HUD.shadowValue.get().equals("Autumn")) {
                drawText(currentText, x + 1f, currY + 1f, Color(20, 20, 20, 200).rgb, true)
            } else if (HUD.shadowValue.get().equals("Blue")) {
                drawText(currentText, x + 1f, currY + 1f, Color(100,149,237,200).rgb, true)
            } else if (HUD.shadowValue.get().equals("Sb")) {
                drawText(currentText, x + 1f, currY + 1f, ColorUtils.rainbow().rgb
                    , true)
