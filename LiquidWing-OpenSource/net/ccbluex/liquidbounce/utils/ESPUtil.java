...
public class ESPUtil{
    ...
    public static double[] getInterpolatedPos(Entity entity) {
        ...
        return new double[]{
                net.ccbluex.liquidbounce.utils.misc.MathUtils.interpolate(entity.lastTickPosX, entity.posX, ticks) -Minecraft.getMinecraft().getRenderManager().viewerPosX,
                net.ccbluex.liquidbounce.utils.misc.MathUtils.interpolate(entity.lastTickPosY, entity.posY, ticks) - Minecraft.getMinecraft().getRenderManager().viewerPosY,
                net.ccbluex.liquidbounce.utils.misc.MathUtils.interpolate(entity.lastTickPosZ, entity.posZ, ticks) -Minecraft.getMinecraft().getRenderManager().viewerPosZ
        };
    }
