...
fun Entity.getDistanceToEntityBox(entity: Entity): Double {
    ...
    val pos = getNearestPointBB(eyes.wrap(), entity.entityBoundingBox)
    val xDist = abs(pos.xCoord - eyes.x)
    val yDist = abs(pos.yCoord - eyes.y)
    val zDist = abs(pos.zCoord - eyes.z)
    return sqrt(xDist.pow(2) + yDist.pow(2) + zDist.pow(2))
}
fun getNearestPointBB(eye: WVec3, box: AxisAlignedBB): WVec3 {
