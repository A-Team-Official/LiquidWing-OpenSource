...
public class AStarCustomPathFinder {
    ...
    private static boolean isBlockSolid(BlockPos block) {
        ...
        return BlockUtil.isSolidFullCube(block) ||
        		(BlockUtil.getBlock(block) instanceof BlockSlab) ||
        		(BlockUtil.getBlock(block) instanceof BlockStairs)||
        		(BlockUtil.getBlock(block) instanceof BlockCactus)||
        		(BlockUtil.getBlock(block) instanceof BlockChest)||
        		(BlockUtil.getBlock(block) instanceof BlockEnderChest)||
        		(BlockUtil.getBlock(block) instanceof BlockSkull)||
        		(BlockUtil.getBlock(block) instanceof BlockPane)||
        		(BlockUtil.getBlock(block) instanceof BlockFence)||
        		(BlockUtil.getBlock(block) instanceof BlockWall)||
        		(BlockUtil.getBlock(block) instanceof BlockGlass)||
        		(BlockUtil.getBlock(block) instanceof BlockPistonBase)||
        		(BlockUtil.getBlock(block) instanceof BlockPistonExtension)||
        		(BlockUtil.getBlock(block) instanceof BlockPistonMoving)||
        		(BlockUtil.getBlock(block) instanceof BlockStainedGlass)||
        		(BlockUtil.getBlock(block) instanceof BlockTrapDoor);
    }

    private static boolean isSafeToWalkOn(BlockPos block) {
        return !(BlockUtil.getBlock(block) instanceof BlockFence) && 
        		!(BlockUtil.getBlock(block) instanceof BlockWall);
    }
