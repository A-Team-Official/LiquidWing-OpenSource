...
import net.ccbluex.liquidbounce.utils.render.Colors.blendColors
...
object ColorUtils {
    ...
    fun rainbowWithAlpha(alpha: Int) = reAlpha1(hslRainbow(1),alpha)
    fun reAlpha1(color: Color,alpha: Int): Color{
        return Color(color.red,color.green,color.blue,alpha)
    }
